...
class RaiPlayMain(Screen):
    ...
    def okRun(self):
        ...
        if category == "live_tv":
            ...
            self.session.open(
                MessageBox,
                _("Category not implemented yet"),
...
class RaiPlayOnDemandCategory(Screen):
    ...
    def okRun(self):
        ...
        if item['type'] == "video":
            ...
            print(
                "RaiPlayOnDemandProgram, item['name'], item['url'] =",
                item['name'],
                item['url'])
            self.session.open(
            ...
            print(
                "Opening RaiPlayOnDemandCategory with name =",
                item.get('name'),
                ", url =",
                item.get('url'),
                ", sub-type =",
    ...
    def _play_video(self, item):
        ...
        try:
            ...
            self.session.open(
                MessageBox, _("Error playing video: %s") %
...
def main(session, **kwargs):
    try:
        ...
        session.open(
            MessageBox,
            _("Errore nell'avvio del plugin"),
            MessageBox.TYPE_ERROR)
